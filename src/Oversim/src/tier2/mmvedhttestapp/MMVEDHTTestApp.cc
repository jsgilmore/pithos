...
#include "MMVEDHTTestApp.h"

Define_Module(MMVEDHTTestApp);

using namespace std;

MMVEDHTTestApp::~MMVEDHTTestApp()
{
...
void MMVEDHTTestApp::initializeApp(int stage)
{
...
void MMVEDHTTestApp::handleRpcResponse(BaseResponseMessage* msg,
...
void MMVEDHTTestApp::handlePutResponse(DHTputCAPIResponse* msg,
...
void MMVEDHTTestApp::handleGetResponse(DHTgetCAPIResponse* msg,
                                   DHTStatsContext* context)
{
    if (context->measurementPhase == false) {
        // don't count response, if the request was not sent
...
void MMVEDHTTestApp::handleTraceMessage(cMessage* msg)
{
    ...
    if (strncmp(cmd, "PUT ", 4) == 0) {
        ...
        sendInternalRpcCall(OVERLAYSTORAGE_COMP, dhtPutMsg,
...
void MMVEDHTTestApp::handleTimerEvent(cMessage* msg)
{
...
void MMVEDHTTestApp::handleNodeLeaveNotification()
{
    nodeIsLeavingSoon = true;
}

void MMVEDHTTestApp::finishApp()
{
