...
CompType BaseApp::getThisCompType()
{
    ...
    else if (name == std::string("agent")) {
           return AGENT_COMP;
    }
    else if (name == std::string("eventLayerIM")) {
           return EVENTLAYERIM_COMP;
    }
    else if (name == std::string("eventDissemination")) {
           return EVENTDISSEMINATION_COMP;
    }
    else if (name == std::string("eventOrdering")) {
           return EVENTORDERING_COMP;
    }
    else if (name == std::string("gameLogic")) {
           return GAMELOGIC_COMP;
    }
    else if (name == std::string("rootObjectUpdater")) {
           return ROOTOBJECTUPDATER_COMP;
    }
    else if (name == std::string("rootObjectStore")) {
           return ROOTOBJECTSTORE_COMP;
    }
    else if (name == std::string("overlayStorage")) {
               return OVERLAYSTORAGE_COMP;
    }
    else if (name == std::string("updateLayerIM")) {
           return UPDATELAYERIM_COMP;
    }
    else if (name == std::string("updateDissemination")) {
           return UPDATEDISSEMINATION_COMP;
    }
    else if (name == std::string("objectMerger")) {
           return OBJECTMERGER_COMP;
    }
    else if (name == std::string("localObjectUpdater")) {
           return LOCALOBJECTUPDATER_COMP;
    }
    else if (name == std::string("localObjectStore")) {
           return LOCALOBJECTSTORE_COMP;
    }
    else if (name == std::string("displayUpdater")) {
           return DISPLAYUPDATER_COMP;
    }
    ...
    if (parentName == std::string("tier1")) {
        ...
        return TIER3_COMP;
    } else if (parentName == std::string("agent")) {
        return AGENT_COMP;
	}
	else if (parentName == std::string("eventLayerIM")) {
		return EVENTLAYERIM_COMP;
	}
	else if (parentName == std::string("eventDissemination")) {
		return EVENTDISSEMINATION_COMP;
	}
	else if (parentName == std::string("eventOrdering")) {
		return EVENTORDERING_COMP;
	}
	else if (parentName == std::string("gameLogic")) {
		return GAMELOGIC_COMP;
	}
	else if (parentName == std::string("rootObjectUpdater")) {
		return ROOTOBJECTUPDATER_COMP;
	}
	else if (parentName == std::string("rootObjectStore")) {
		return ROOTOBJECTSTORE_COMP;
	}
	else if (parentName == std::string("overlayStorage")) {
		   return OVERLAYSTORAGE_COMP;
	}
	else if (parentName == std::string("updateLayerIM")) {
		return UPDATELAYERIM_COMP;
	}
	else if (parentName == std::string("updateDissemination")) {
		return UPDATEDISSEMINATION_COMP;
	}
	else if (parentName == std::string("objectMerger")) {
		return OBJECTMERGER_COMP;
	}
	else if (parentName == std::string("localObjectUpdater")) {
		return LOCALOBJECTUPDATER_COMP;
	}
	else if (parentName == std::string("localObjectStore")) {
		return LOCALOBJECTSTORE_COMP;
	}
	else if (parentName == std::string("displayUpdater")) {
		return DISPLAYUPDATER_COMP;
	}
    else {

    	throw cRuntimeError("BaseApp::getThisCompType(): Unknown module type! ");
    }
