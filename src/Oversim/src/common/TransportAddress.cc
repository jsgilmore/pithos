...
{
	//This is a very expensive operation that should never occur. This line was removed after completion of development of the simulation to improve run time.
