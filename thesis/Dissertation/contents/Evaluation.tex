...
\section{Performance under network churn}
...
\section{Reliability (security) under malicious nodes}
...
\begin{figure}[htbp]
 \centering
 \includegraphics[clip=true, viewport=15mm 30mm 270mm 180mm, width=\columnwidth]{malicious_nodes_rel}
