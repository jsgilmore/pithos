...
\begin{figure}[htbp]
 \centering
 \includegraphics[clip=true, viewport=10mm 20mm 270mm 170mm, width=\columnwidth]{group_put_sf}
...
\begin{figure}[htbp]
 \centering
 \includegraphics[clip=true, viewport=20mm 20mm 265mm 180mm, width=\columnwidth]{group_get_fp}
...
\end{figure}
%
Figure \ref{fig_overlay_get_lan_wide} shows the responsiveness of overlay storage for the LAN underlay network. Three groups of latencies can be observed. One close to zero seconds, one at 1.5s and another at 3s. The first group contains 96\% of overlay requests, the second 1\% and the third, 3\%. The second and third groups are thought to be timeout that occur within the third-party overlay implementation begin used.
...
The mean overlay retrieval for LAN responsiveness is 0.130s, which is significantly slower than the 0.0016s of group retrieval for LAN responsiveness.
...
\begin{figure}[htbp]
 \centering
 \includegraphics[clip=true, viewport=15mm 35mm 275mm 170mm, width=\columnwidth]{repair_rel}
...
\begin{figure}[htbp]
 \centering
 \includegraphics[clip=true, viewport=10mm 45mm 275mm 160mm, width=\columnwidth]{repair_bw}
