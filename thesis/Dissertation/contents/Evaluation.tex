...
The Pithos simulation has, however, been successfully evaluated using Pareto lifetime distributions and an experiment was done to show the the differences between the two distributions.
