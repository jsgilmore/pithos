...
To our knowledge, no literature exist that present a comprehensive picture of a state consistency architecture. In this chapter, papers will be discussed that individually implement all modules of the consistency architecture, but none were found to provide an overview of a complete state consistency model.
...
\begin{figure}[htbp]
 \centering
 \includegraphics[clip=true, viewport=46mm 84mm 196mm 287mm, width=0.72\textwidth]{generic_consistency_flowdiagram}
...
The event-based model has fallen into disuse over the past few years, because of its lack of scalability and the slow-down experienced when high latency nodes are connected due to the event ordering techniques used.
...
\begin{figure}[htbp]
 \centering
 \includegraphics[clip=true, viewport=30mm 60mm 179mm 253mm, width=0.72\textwidth]{generic_to_cs}
