...
Some key requirements exist for the creation of a P2P MMVE. These include: security, incentive mechanisms, distributed computation, state consistency and a P2P overlay.
