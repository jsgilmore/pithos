...
For simulation purposes, each super peer is assigned a random location created by sampling both an x and a y coordinate from a uniform random distribution. Joining peers are assigned positions in the same uniform random manner when they are initialised.
...
When a new position is generated by PithosTestApp, this is sent to the group storage module.
