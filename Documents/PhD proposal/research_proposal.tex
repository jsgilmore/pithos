...
%Mediator
%Badumna
%Voronoi based, named by Mediator
%Maybe another one
...
For MMOGs, there are various methods employed to achieve this. Sony introduced the first distribution method in Everquest, where copies of the game world ran on different servers and players then connect to one of these servers \cite{engineering_everquest}. Sony termed this method: ``Sharding''.
