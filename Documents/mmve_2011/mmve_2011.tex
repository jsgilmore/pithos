...
\includegraphics[width=0.652\columnwidth]{tier1_peer}}
 \subfloat[Super Peer]{\label{fig_super_peer}
\includegraphics[width=0.8\columnwidth]{tier1_super_peer}}
...
\begin{figure}[htbp]
 \centering
 \includegraphics[clip=true, viewport=2cm 1cm 27cm 19.5cm, width=\columnwidth]{Hops_vsNodes_4GroupFrac}
 \caption{Time distribution of overlay and root/replica objects}
 \label{fig_pithos_response}
\end{figure}
